...
<!-- <body style = "background:url(http://xdesktopwallpapers.com/wp-content/uploads/2011/04/Girls-After-Shopping.jpghttp://xdesktopwallpapers.com/wp-content/uploads/2011/04/Girls-After-Shopping.jpg);  background-size:100% 100%;">
 -->
<div id="wrap">
  ...
  <div class="row">
	 ...
	 <thead>
		...
		<tbody>
			...
			<div class="media">
			 <a class="thumbnail pull-left" href=""><img class="media-object" src="/SheLavishFront/myImage/imageDisplay?id=${cart.productId}" class="img-thumbnail" width="72px" height="72px"/></a>
